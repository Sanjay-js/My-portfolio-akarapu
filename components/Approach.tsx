    ...
    <section id="projects" className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          icon={<AceternityIcon order="Cloud&others" />}
          des=""
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 px-10">
        ...
        group-hover/canvas-card:opacity-0 transition duration-200 min-w-70 mx-auto flex items-center justify-center overflow-hidden"
        >
          {icon}
        </div>
        <ul
